...
public class ApiPostRequest extends Base{
	...
	public static void postDetails(String sno, String description, String baseurl, String page, String email, String job, String name, String password, String responsedata, String responseCode) {
